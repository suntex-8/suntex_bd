      ...
      <div className="mx-auto max-w-7xl px-5 lg:px-8">
        <div className="mb-12 text-center">
          ...
          <motion.h2
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="text-[32px] leading-[1.08] text-white sm:text-4xl lg:text-[44px]"
          >
        ...
        <div className="grid gap-px overflow-hidden border border-white/10 bg-white/10 sm:grid-cols-2 lg:grid-cols-4">
          {factoryNetworkData.locations.map((loc, i) => (
            <motion.div
              ...
              className="flex items-center gap-3 bg-ink p-5"
            >
        ...
        <div className="mt-8 flex flex-wrap justify-center gap-4">
          {factoryNetworkData.advantages.map((a) => (
            <div key={a} className="flex items-center gap-2 text-sm text-white/65">
